  ...
  const updateStyles = () => {
    if (refElement.current) {
      ...
      Object.entries({
        ...
        refElement.current?.style.setProperty(key, value);
      });
    }
  };
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)]",
    ...
    >
      <div
        className={cn(
          "h-full grid will-change-transform origin-center",
          "transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)]",
          "[transform:rotateY(var(--r-x))_rotateX(var(--r-y))]",
          "rounded-[var(--radius)] border border-slate-800",
          `hover:[--opacity:${glareOpacity}]`,
          "hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none",
          "overflow-hidden"
        )}
      >
        {/* Content Layer */}
        ...
        <div
          className={cn(
            ...
            "opacity-[var(--opacity)] transition-opacity transition-background",
            "duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)]",
        ...
        <div
          className={cn(
            ...
            "opacity-[var(--opacity)] will-change-background transition-opacity",
            "[clip-path:inset(0_0_1px_0_round_var(--radius))]",
